...
CreateConVar("randomat_amongus_voting_timer", 30, FCVAR_NONE, "Seconds voting time lasts", 0, 300)
CreateConVar("randomat_amongus_discussion_timer", 15, FCVAR_NONE, "Seconds discussion time lasts, set to 0 to disable", 0, 120)
CreateConVar("randomat_amongus_votepct", 0, FCVAR_NONE, "Vote percentage required to eject", 0, 100)
CreateConVar("randomat_amongus_freeze", 1, FCVAR_NONE, "Freeze players in place while voting", 0, 1)
CreateConVar("randomat_amongus_knife_cooldown", 20, FCVAR_NONE, "Traitor knife kill cooldown in seconds", 10, 60)
CreateConVar("randomat_amongus_emergency_delay", 15, FCVAR_NONE, "Emergency meeting delay in seconds", 0, 60)
CreateConVar("randomat_amongus_confirm_ejects", 0, FCVAR_NONE, "Notify everyone of a player's role when voted out", 0, 1)
CreateConVar("randomat_amongus_emergency_meetings", 1, FCVAR_NONE, "No. of emergency meetings per player", 0, 9)
CreateConVar("randomat_amongus_anonymous_voting", 0, FCVAR_NONE, "Anonymous voting", 0, 1)
CreateConVar("randomat_amongus_player_speed", 1, FCVAR_NONE, "Player speed multiplier", 0.5, 3)
CreateConVar("randomat_amongus_innocent_vision", 1, FCVAR_NONE, "Innocent vision multiplier", 0.2, 5)
CreateConVar("randomat_amongus_traitor_vision", 1.5, FCVAR_NONE, "Traitor vision multiplier", 0.2, 5)
CreateConVar("randomat_amongus_taskbar_update", 0, FCVAR_NONE, "Only update taskbar at meetings", 0, 1)
CreateConVar("randomat_amongus_auto_trigger", 1, FCVAR_NONE, "Trigger every round on special map: ttt_amongusskeld", 0, 1)
CreateConVar("randomat_amongus_task_threshhold", 60, FCVAR_NONE, "Seconds until tasks/guns aren't found too quickly", 0, 120)
local sprintingCvar = CreateConVar("randomat_amongus_sprint", 1, FCVAR_NONE, "Enable sprinting during the randomat", 0, 1)
CreateConVar("randomat_amongus_music", 1, FCVAR_NONE, "Play the Among Us drip music", 0, 1)
local traitorCapCvar = CreateConVar("randomat_amongus_traitor_cap", 0, FCVAR_NONE, "Max number of traitors, set to 0 to disable", 0)
